...
dispatcher.add_handler(CommandHandler('gstart', start_game, pass_args=True, pass_job_queue=True))
dispatcher.add_handler(CommandHandler('gnew', new_game))
dispatcher.add_handler(CommandHandler('gkill', kill_game))
dispatcher.add_handler(CommandHandler('gjoin', join_game))
dispatcher.add_handler(CommandHandler('gleave', leave_game))
dispatcher.add_handler(CommandHandler('gkick', kick_player))
dispatcher.add_handler(CommandHandler('gopen', open_game))
dispatcher.add_handler(CommandHandler('gclose', close_game))
